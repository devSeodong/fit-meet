 ...
 * 인증 없이 접근 허용 (로그인/회원가입 등) - 그 외 /api/** 는 인증 필요
 */
@Configuration
...
public class SecurityConfig {
	...
	/**
	 * 비밀번호 암호화를 위한 PasswordEncoder - 회원가입 시 비밀번호 해시 - 로그인 시 입력값 검증
	 */
	@Bean
	...
	/**
	 * AuthenticationManager - AuthController에서 로그인 시
	 * UsernamePasswordAuthenticationToken을 검증할 때 사용
	 */
	@Bean
